...
const Header = () => {
  return (
    ...
    md:px-20 lg:px-32 text-white '>
        ...
        <a href="#Projects" className='border border-white px-8 py-3 rounded hover:animate-pulse'>Projects</a>
        <a href="#Contact" className='bg-blue-500 px-8 py-3 rounded hover:animate-pulse'>ContactUS</a>
         </div>
